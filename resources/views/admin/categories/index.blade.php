                ...
                <div class="card-block">
                  <form id="search-form" action="{{ route('admin.categories.index') }}" method="get">
                    <div class="form-group search-form-box">
                      ...
                      <input type="number" class="form-control" id="id" name="id" placeholder="カテゴリーID"
                    ...
                    <div class="form-group row">
                      ...
                      <div class="m-2">
                        <a class="btn btn-secondary waves-effect waves-light"
                          href="{{ route('admin.categories.index') }}">リセット</a>
                      </div>
                    </div>
                  </form>
                </div>
                        ...
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-primary btn-sm m-1"
                              href="{{ route('admin.categories.detail', ['id' => $category->id]) }}">詳細</a>
                          </td>
                          <td>
                            <a class="btn btn-success btn-sm m-1"
                              href="{{ route('admin.categories.editView', ['id' => $category->id]) }}">編集</a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
